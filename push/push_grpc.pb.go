...
const (
	PushMsgService_PushMsg_FullMethodName          = "/OpenIMServer.push.PushMsgService/PushMsg"
	PushMsgService_DelUserPushToken_FullMethodName = "/OpenIMServer.push.PushMsgService/DelUserPushToken"
)
...
func (c *pushMsgServiceClient) PushMsg(ctx context.Context, in *PushMsgReq, opts ...grpc.CallOption) (*PushMsgResp, error) {
	out := new(PushMsgResp)
	err := c.cc.Invoke(ctx, PushMsgService_PushMsg_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pushMsgServiceClient) DelUserPushToken(ctx context.Context, in *DelUserPushTokenReq, opts ...grpc.CallOption) (*DelUserPushTokenResp, error) {
	...
	err := c.cc.Invoke(ctx, PushMsgService_DelUserPushToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
