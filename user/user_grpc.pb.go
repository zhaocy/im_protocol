...
const (
	User_GetDesignateUsers_FullMethodName            = "/OpenIMServer.user.user/getDesignateUsers"
	User_UpdateUserInfo_FullMethodName               = "/OpenIMServer.user.user/updateUserInfo"
	User_SetGlobalRecvMessageOpt_FullMethodName      = "/OpenIMServer.user.user/setGlobalRecvMessageOpt"
	User_GetGlobalRecvMessageOpt_FullMethodName      = "/OpenIMServer.user.user/getGlobalRecvMessageOpt"
	User_AccountCheck_FullMethodName                 = "/OpenIMServer.user.user/accountCheck"
	User_GetPaginationUsers_FullMethodName           = "/OpenIMServer.user.user/getPaginationUsers"
	User_UserRegister_FullMethodName                 = "/OpenIMServer.user.user/userRegister"
	User_GetAllUserID_FullMethodName                 = "/OpenIMServer.user.user/getAllUserID"
	User_UserRegisterCount_FullMethodName            = "/OpenIMServer.user.user/userRegisterCount"
	User_SubscribeOrCancelUsersStatus_FullMethodName = "/OpenIMServer.user.user/subscribeOrCancelUsersStatus"
	User_GetSubscribeUsersStatus_FullMethodName      = "/OpenIMServer.user.user/getSubscribeUsersStatus"
	User_GetUserStatus_FullMethodName                = "/OpenIMServer.user.user/getUserStatus"
	User_SetUserStatus_FullMethodName                = "/OpenIMServer.user.user/setUserStatus"
)
...
func (c *userClient) GetDesignateUsers(ctx context.Context, in *GetDesignateUsersReq, opts ...grpc.CallOption) (*GetDesignateUsersResp, error) {
	...
	err := c.cc.Invoke(ctx, User_GetDesignateUsers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetGlobalRecvMessageOpt(ctx context.Context, in *GetGlobalRecvMessageOptReq, opts ...grpc.CallOption) (*GetGlobalRecvMessageOptResp, error) {
	...
	err := c.cc.Invoke(ctx, User_GetGlobalRecvMessageOpt_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetPaginationUsers(ctx context.Context, in *GetPaginationUsersReq, opts ...grpc.CallOption) (*GetPaginationUsersResp, error) {
	...
	err := c.cc.Invoke(ctx, User_GetPaginationUsers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) UserRegisterCount(ctx context.Context, in *UserRegisterCountReq, opts ...grpc.CallOption) (*UserRegisterCountResp, error) {
	...
	err := c.cc.Invoke(ctx, User_UserRegisterCount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) SubscribeOrCancelUsersStatus(ctx context.Context, in *SubscribeOrCancelUsersStatusReq, opts ...grpc.CallOption) (*SubscribeOrCancelUsersStatusResp, error) {
	...
	err := c.cc.Invoke(ctx, User_SubscribeOrCancelUsersStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetSubscribeUsersStatus(ctx context.Context, in *GetSubscribeUsersStatusReq, opts ...grpc.CallOption) (*GetSubscribeUsersStatusResp, error) {
	...
	err := c.cc.Invoke(ctx, User_GetSubscribeUsersStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetUserStatus(ctx context.Context, in *GetUserStatusReq, opts ...grpc.CallOption) (*GetUserStatusResp, error) {
	...
	err := c.cc.Invoke(ctx, User_GetUserStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
